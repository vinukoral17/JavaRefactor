...
public class Domino implements Comparable<Domino> {
	...
	/*
	 * ##### - UNUSED VARIABLES The tx and ty variables in the invert() method are
	 * used only for temporary storage and can be eliminated.
	 */
	...
	/*
	 * The method CompareTo() compared 'Domino' objects based on thier high and low
	 * values
	 * 
	 * @param arg() the Domino object to tbe compared with this object.
	 * 
	 * @return an integer value indicating the order of the two objects If
	 * 'this.higher' is less than `arg0.high` it returns `1` Otherwise, it return
	 * `this.low - arg0.low`.
	 */
